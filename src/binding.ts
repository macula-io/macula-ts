...
export const native = require("node-gyp-build")(repoRoot) as {
  ...
  poolGetContent(pool: Handle, realm: Uint8Array, mcid: Uint8Array, maxBytes: number, maxChunks: number, parallel: number,
    chunkTimeoutMs: number, timeoutMs: number): Promise<Uint8Array>;
